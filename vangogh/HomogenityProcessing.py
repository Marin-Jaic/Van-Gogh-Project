...
def detect_homogeneous_areas(image_path, threshold=20, kernel_size=5):
    ...
    # Step 3: Calculate the standard deviation of colors in a sliding window
...
result_image, homogeneous_mask = detect_homogeneous_areas(image_path, threshold=2, kernel_size=3)

# Save or display the results
result_image.save('homogeneous_areas.png')
homogeneous_mask.save('homogeneous_mask.png')
